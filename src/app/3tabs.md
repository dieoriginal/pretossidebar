...
}, this code works perfectly but, there is some tweaks i want you to do, WHILE USING THE APP I ATUALLY NOTICES THWE THE FOLLOWING

I CANT SORT THE VERSES, I MEAN I CAN BUT WHEN I DRAG IT WORK BUT WHEN I GO TO DROP WHERE I WANT THAT VERSE TO BE NOEW, IT DOESNT STICK TO IT , IT GETS BACK TO THE OLDER POSISION AS IF IT WAS LOKED, 

I WANT DSORTABILITY IN ESTROFES TOO IF POSSIBLE, I.E: SWAP THE ESTRFE 1 TO ESTROFE 2 CAUSE IT SOUNDS BETTER

,

STILL IN VERSIFICAÇAO TAB, 

THE X BUTTON TO REMOVE EACH WORD IN THE VERSE, IT WORKS WORNGLY, IT ACTUAL REMOVE THE LAST WORD NO MATTER WHICH X FROM THE VERSE I CLICK, I WANT IT WHEN I CLICK THE X OF THE X WORD IN THE VERSE, ONLY THAT WORD REMOVES ITSELF,

ALL IM NOTTINCG SOMETIMES WHEN I CREATE OTHER MORE ESTROFES, I INPUT THE VERSE BUT WHEN I HIT ADICIONAR VERSO, IT LOADS NOTHING, 

ALSO THE PDF THING IS NOT WORKING PROPERLY WHEN I CLICK EXPORT TO PDF IDK WHY, ALSO , I WANT TO HAVE A PREVISUASILAR AND EXPORT PDF JUST FOR CINEMATOGRAFIA, AND IN CINEMATOGRAFIA I WANT THE POSSIBILITY OF UPLADING A FILES (IMAGE OR 5s max viDEOS) SO THERE IS A VISUAL REFERENCE TO WHAT IM TRYING TO GET ACROSS WHEN GO TO FILMING, AND, THE PRE VISUALIZAR ALSO SHOWS THE CINEMATOGRAFIA CHOSEN ELEMENTS AND THE MOST IMPORTA THE UPLOADED FILE AS IF IT WAS A DOCUMENT BEING BILT, JUST LIKE THE OTHER

IN FIGURAS, MÉTRICA E ARQUITETURA, I WANT TO ADD ONE MORE CATEGORY TO CHOOSE TYPE OF VOICE, LOW VOICE, GUCCI MANE VOICE, HIGH PITCH VOICE,
SAME RULES: 
SAME RULES:
