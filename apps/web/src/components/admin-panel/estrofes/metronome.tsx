...
class Metronome extends Component<{}, MetronomeState> {
  ...
  private click1: HTMLAudioElement | null = null;
  private click2: HTMLAudioElement | null = null;
  ...
  constructor(props: {}) {
    ...
    // Audio só existe no browser; cria em componentDidMount
  }
  ...
  playClick = () => {
    if (!this.click1 || !this.click2) return;
